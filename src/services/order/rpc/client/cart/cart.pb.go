...
func (x *CartInfo) GetCustomerId() string {
	if x != nil {
		return x.CustomerId
	}
	return ""
...
func (x *CartData) GetCustomerId() string {
	if x != nil {
		return x.CustomerId
	}
	return ""
...
func (x *CartData) GetItems() []*CartItem {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_proto_cart_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x63, 0x61, 0x72, 0x74, 0x22, 0x2a, 0x0a, 0x08, 0x43, 0x61, 0x72, 0x74,
	0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
	0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	0x65, 0x72, 0x49, 0x64, 0x22, 0x60, 0x0a, 0x08, 0x43, 0x61, 0x72, 0x74, 0x44, 0x61, 0x74, 0x61,
	...
	0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x44, 0x0a, 0x08, 0x43, 0x61, 0x72, 0x74, 0x49, 0x74,
	...
	,
...
var file_proto_cart_proto_goTypes = []interface{}{
	...
	(*CartData)(nil), // 1: cart.CartData
	(*CartItem)(nil), // 2: cart.CartItem
}
var file_proto_cart_proto_depIdxs = []int32{
	2, // 0: cart.CartData.items:type_name -> cart.CartItem
	0, // 1: cart.Cart.GetSingleCart:input_type -> cart.CartInfo
	0, // 2: cart.Cart.ClearCart:input_type -> cart.CartInfo
	1, // 3: cart.Cart.GetSingleCart:output_type -> cart.CartData
	1, // 4: cart.Cart.ClearCart:output_type -> cart.CartData
